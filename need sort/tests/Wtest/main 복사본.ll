...
%struct.__sFILE = type { i8*, i32, i32, i1 6, i16, %struct.__sbuf, i32, i8*, i32 (i8*)*, i32 (i8*, i8*, i32)*, i64 (i8*, i64, i32)*, i32 (i8*, i8*, i32)*, %struct.__sbuf, %struct.__sFILEX*, i32, [3 x i8], [1 x i8], %struct.__sbuf, i32, i64 }
...
;op type
@.str_op_declare = private unnamed_addr constant [8 x i8] c"declare\00", align 1
@.str_op_sum = private unnamed_addr constant [4 x i8] c"sum\00", align 1
@.str_op_mul = private unnamed_addr constant [4 x i8] c"mul\00", align 1
@.str_op_sub = private unnamed_addr constant [4 x i8] c"sub\00", align 1
...
entry:
  ...
  ;%call_var_1_op = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str_op_declare, i64 0, i64 0))


  ;char var_1_name[] = GET_NAME(xxxx);
  ...
  %call_var_1_name = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_str, i64 0, i64 0), i8* %arraydecay)
