...
@.str.openfile = private unnamed_addr constant [9 x i8] c"aaaa.txt\00", align 1
...
define void @write_var_info(i32* %var, i32 %linenum, i32 %tempaaa) #0 #1 {

  %loadfile = load %struct.__sFILE*, %struct.__sFILE** @file, align 8

%var_value = load i32, i32* %var, align 4
  %var_name_ptr = alloca [6 x i8], align 1
  %temp_var_name = bitcast [6 x i8]* %var_name_ptr to i8*

  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %temp_var_name, i8* align 1 getelementptr inbounds ([6 x i8], [6 x i8]* @__const.main.var_1_name, i32 0, i32 0), i64 5, i1 false)

%var_name = getelementptr inbounds [6 x i8], [6 x i8]* %var_name_ptr, i64 0, i64 0

  
  %call1 = call i8* @_ZNKSt9type_info4nameB6v15006Ev(%"class.std::type_info"* bitcast (i8** @_ZTIi to %"class.std::type_info"*)) #888
  %call2 = call i8* @_ZNKSt9type_info4nameB6v15006Ev(%"class.std::type_info"* bitcast (i8** @_ZTIi to %"class.std::type_info"*)) #888
  
  %cmptype = icmp eq i8* %call1, %call2
  br i1 %cmptype, label %if.then, label %if.end
if.then:                                          ; preds = %entry
%var_type = call i8* @_ZNKSt9type_info4nameB6v15006Ev(%"class.std::type_info"* bitcast (i8** @_ZTIi to %"class.std::type_info"*)) #888
  br label %if.end
if.end:  

  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.op_declare, i64 0, i64 0))
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_str, i64 0, i64 0), i8* %var_name)
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_str, i64 0, i64 0), i8* %var_type)
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_int, i64 0, i64 0), i32 %var_value)
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_ptr, i64 0, i64 0), i32* %var)
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_int, i64 0, i64 0), i32 %linenum)
...
call void @func2()
  ...
  store i32 5, i32* %zzzzz, align 4
            ...
            call void @write_var_info(i32* %xxxxx, i32 8, i32 6)
;===========================aaaaaaaaaa=======================
;======================================================================
%loadfile = load %struct.__sFILE*, %struct.__sFILE** @file, align 8
