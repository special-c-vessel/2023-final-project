...
@__const.main.var_2_name = private unnamed_addr constant [5 x i8] c"yyyy\00", align 1
@__const.main.var_3_name = private unnamed_addr constant [5 x i8] c"zzzz\00", align 1
...
entry:
  ...
  ;int yyyy = 3, int zzzz = 7;
  %yyyy = alloca i32, align 4
  store i32 3, i32* %yyyy, align 4
  %var_2_value = load i32, i32* %yyyy, align 4

  %zzzz = alloca i32, align 4
  store i32 7, i32* %zzzz, align 4
  %var_3_value = load i32, i32* %zzzz, align 4
  ...
  ;char str222[] = GET_NAME(xxxx); , yyyy, zzzz
  %var_1_name_ptr = alloca [5 x i8], align 1
  %temp_var_1_name = bitcast [5 x i8]* %var_1_name_ptr to i8*
  ...
  %var_1_name = getelementptr inbounds [5 x i8], [5 x i8]* %var_1_name_ptr, i64 0, i64 0


  %var_2_name_ptr = alloca [5 x i8], align 1
  %temp_var_2_name = bitcast [5 x i8]* %var_2_name_ptr to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %temp_var_2_name, i8* align 1 getelementptr inbounds ([5 x i8], [5 x i8]* @__const.main.var_2_name, i32 0, i32 0), i64 5, i1 false)
  %var_2_name = getelementptr inbounds [5 x i8], [5 x i8]* %var_2_name_ptr, i64 0, i64 0


  %var_3_name_ptr = alloca [5 x i8], align 1
  %temp_var_3_name = bitcast [5 x i8]* %var_3_name_ptr to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %temp_var_3_name, i8* align 1 getelementptr inbounds ([5 x i8], [5 x i8]* @__const.main.var_3_name, i32 0, i32 0), i64 5, i1 false)
  %var_3_name = getelementptr inbounds [5 x i8], [5 x i8]* %var_3_name_ptr, i64 0, i64 0
  ...
  br i1 %cmptype, label %if.thenaa, label %if.endaa

  ;      cout << "int" << "\n";
  ;      fprintf(file, "%s\n", typeid(xxxx).name());
if.thenaa:                                          ; preds = %entry
...
if.endaa:    
  ...
  ;fprintf(file, "%p\n", &xxxx);
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_ptr, i64 0, i64 0), i32* %xxxx)

  ; fprint line number
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_int, i64 0, i64 0), i32 19)
...
;yyyyyyyyyyyyyyyyyyyyyyyy
  ...
  %call33 = call i8* @_ZNKSt9type_info4nameB6v15006Ev(%"class.std::type_info"* bitcast (i8** @_ZTIi to %"class.std::type_info"*)) #8
  %call44 = call i8* @_ZNKSt9type_info4nameB6v15006Ev(%"class.std::type_info"* bitcast (i8** @_ZTIi to %"class.std::type_info"*)) #8
  %cmptype2 = icmp eq i8* %call33, %call44
  br i1 %cmptype2, label %if.thencc, label %if.enddd
if.thencc:                                          ; preds = %entry
  %var_2_type = call i8* @_ZNKSt9type_info4nameB6v15006Ev(%"class.std::type_info"* bitcast (i8** @_ZTIi to %"class.std::type_info"*)) #8
...
if.enddd:    
  ...
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_ptr, i64 0, i64 0), i32* %yyyy)
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_int, i64 0, i64 0), i32 20)
;yyyyyyyyyyyyyyyyyyyyyyyy
...
if.endff:    
  ...
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_ptr, i64 0, i64 0), i32* %zzzz)
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_int, i64 0, i64 0), i32 21)
;zzzzzzzzzzzzzzzzzzzzzzzzzzzzzz

  ;; add func +++++++++++++++++++++++++++++++++++
  ; zzzz = xxxx + yyyy  x = 5, y = 3
  ...
  ; add sum 
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.op_sum, i64 0, i64 0))

  ; add var name
  %addxxxxyyyy = add nsw i32 %var_1_value, %var_2_value
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_str, i64 0, i64 0), i8* %var_1_name)
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_str, i64 0, i64 0), i8* %var_2_name)

  store i32 %addxxxxyyyy, i32* %zzzz, align 4
  %var_3_value_2 = load i32, i32* %zzzz, align 4
  ...
  ; add line number
  call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.print_int, i64 0, i64 0), i32 30)
