...
; FILE * file = fopen("test.txt", "w+");  .curly 
...
; #include <string> 
%"class.curly.std::__1::basic_string" = type { %"class.curly.std::__1::__compressed_pair" } 
%"class.curly.std::__1::__compressed_pair" = type { %"struct.curly.std::__1::__compressed_pair_elem" } 
%"struct.curly.std::__1::__compressed_pair_elem" = type { %"struct.curly.std::__1::basic_string<char>::__rep" } 
%"struct.curly.std::__1::basic_string<char>::__rep" = type { %union.curly.anon } 
%union.curly.anon = type { %"struct.curly.std::__1::basic_string<char>::__long" } 
%"struct.curly.std::__1::basic_string<char>::__long" = type { i8*, i64, i64 } 
%"struct.curly.std::__1::__default_init_tag" = type { i8 } 
%"class.curly.std::__1::__basic_string_common" = type { i8 } 
%"struct.curly.std::__1::__compressed_pair_elem.0" = type { i8 } 
%"class.curly.std::__1::allocator" = type { i8 } 
%"struct.curly.std::__1::__non_trivial_if" = type { i8 } 
...
; 변수명 출력	// 지우면 curly_record3.cpp 에서 탐지 못함, 변수명 이후부터 쓰기 시작하기 때문 
; 새로운 전역 str 작성 시작
@__const_curly.my_sock = private unnamed_addr constant [9 x i8] c"my_sock \00", align 1 
@__const_curly.serv_addr = private unnamed_addr constant [11 x i8] c"serv_addr \00", align 1 
@__const_curly.message = private unnamed_addr constant [9 x i8] c"message \00", align 1 
@__const_curly.thread_Cnt = private unnamed_addr constant [12 x i8] c"thread_Cnt \00", align 1 
@__const_curly.str_len = private unnamed_addr constant [9 x i8] c"str_len \00", align 1 
@__const_curly.msg.addr = private unnamed_addr constant [10 x i8] c"msg.addr \00", align 1 
@__const_curly.a.addr = private unnamed_addr constant [8 x i8] c"a.addr \00", align 1 
@__const_curly.cnt2 = private unnamed_addr constant [6 x i8] c"cnt2 \00", align 1 
@__const_curly.tempstr = private unnamed_addr constant [9 x i8] c"tempstr \00", align 1 
@__const_curly.boot = private unnamed_addr constant [6 x i8] c"boot \00", align 1 
@__const_curly.retval = private unnamed_addr constant [8 x i8] c"retval \00", align 1 
@__const_curly.argc.addr = private unnamed_addr constant [11 x i8] c"argc.addr \00", align 1 
@__const_curly.argv.addr = private unnamed_addr constant [11 x i8] c"argv.addr \00", align 1 
@__const_curly.rd = private unnamed_addr constant [4 x i8] c"rd \00", align 1 
@__const_curly.ref.tmp = private unnamed_addr constant [9 x i8] c"ref.tmp \00", align 1 
@__const_curly.exn.slot = private unnamed_addr constant [10 x i8] c"exn.slot \00", align 1 
@__const_curly.ehselector.slot = private unnamed_addr constant [17 x i8] c"ehselector.slot \00", align 1 
@__const_curly.gen = private unnamed_addr constant [5 x i8] c"gen \00", align 1 
@__const_curly.dis = private unnamed_addr constant [5 x i8] c"dis \00", align 1 
@__const_curly.t0 = private unnamed_addr constant [4 x i8] c"t0 \00", align 1 
@__const_curly.t1 = private unnamed_addr constant [4 x i8] c"t1 \00", align 1 
@__const_curly.stringForTest = private unnamed_addr constant [15 x i8] c"stringForTest \00", align 1 
@__const_curly.cnt = private unnamed_addr constant [5 x i8] c"cnt \00", align 1 
@__const_curly.randomNum = private unnamed_addr constant [11 x i8] c"randomNum \00", align 1 
@__const_curly.userInput = private unnamed_addr constant [11 x i8] c"userInput \00", align 1 
@__const_curly.tempnum = private unnamed_addr constant [9 x i8] c"tempnum \00", align 1 
@__const_curly.divNum = private unnamed_addr constant [8 x i8] c"divNum \00", align 1 
@__const_curly.result = private unnamed_addr constant [8 x i8] c"result \00", align 1 
@__const_curly.this.addr = private unnamed_addr constant [11 x i8] c"this.addr \00", align 1 
@__const_curly.__s.addr = private unnamed_addr constant [10 x i8] c"__s.addr \00", align 1 
@__const_curly.__sd.addr = private unnamed_addr constant [11 x i8] c"__sd.addr \00", align 1 
@__const_curly.__a.addr = private unnamed_addr constant [10 x i8] c"__a.addr \00", align 1 
@__const_curly.__b.addr = private unnamed_addr constant [10 x i8] c"__b.addr \00", align 1 
@__const_curly._data.addr = private unnamed_addr constant [12 x i8] c"_data.addr \00", align 1 
@__const_curly.__g.addr = private unnamed_addr constant [10 x i8] c"__g.addr \00", align 1 
@__const_curly.__os.addr = private unnamed_addr constant [11 x i8] c"__os.addr \00", align 1 
@__const_curly.__str.addr = private unnamed_addr constant [12 x i8] c"__str.addr \00", align 1 
@__const_curly.__lhs.addr = private unnamed_addr constant [12 x i8] c"__lhs.addr \00", align 1 
@__const_curly.__rhs.addr = private unnamed_addr constant [12 x i8] c"__rhs.addr \00", align 1 
@__const_curly.__rhs_len = private unnamed_addr constant [11 x i8] c"__rhs_len \00", align 1 
@__const_curly.__pos.addr = private unnamed_addr constant [12 x i8] c"__pos.addr \00", align 1 
@__const_curly.ref.tmp2 = private unnamed_addr constant [10 x i8] c"ref.tmp2 \00", align 1 
@__const_curly.__t1.addr = private unnamed_addr constant [11 x i8] c"__t1.addr \00", align 1 
@__const_curly.__t2.addr = private unnamed_addr constant [11 x i8] c"__t2.addr \00", align 1 
@__const_curly.agg.tmp = private unnamed_addr constant [9 x i8] c"agg.tmp \00", align 1 
@__const_curly.agg.tmp3 = private unnamed_addr constant [10 x i8] c"agg.tmp3 \00", align 1 
@__const_curly.__t.addr = private unnamed_addr constant [10 x i8] c"__t.addr \00", align 1 
@__const_curly.0 = private unnamed_addr constant [3 x i8] c"0 \00", align 1 
@__const_curly.__i = private unnamed_addr constant [5 x i8] c"__i \00", align 1 
@__const_curly.__x.addr = private unnamed_addr constant [10 x i8] c"__x.addr \00", align 1 
@__const_curly.__p.addr = private unnamed_addr constant [10 x i8] c"__p.addr \00", align 1 
@__const_curly._Rp = private unnamed_addr constant [5 x i8] c"_Rp \00", align 1 
@__const_curly._Dt = private unnamed_addr constant [5 x i8] c"_Dt \00", align 1 
@__const_curly.__w = private unnamed_addr constant [5 x i8] c"__w \00", align 1 
@__const_curly.__e = private unnamed_addr constant [5 x i8] c"__e \00", align 1 
@__const_curly.__u = private unnamed_addr constant [5 x i8] c"__u \00", align 1 
@__const_curly.__e.addr = private unnamed_addr constant [10 x i8] c"__e.addr \00", align 1 
@__const_curly.__w.addr = private unnamed_addr constant [10 x i8] c"__w.addr \00", align 1 
@__const_curly.__j = private unnamed_addr constant [5 x i8] c"__j \00", align 1 
@__const_curly.__mask = private unnamed_addr constant [8 x i8] c"__mask \00", align 1 
@__const_curly._Yp = private unnamed_addr constant [5 x i8] c"_Yp \00", align 1 
@__const_curly.__k = private unnamed_addr constant [5 x i8] c"__k \00", align 1 
@__const_curly.__z = private unnamed_addr constant [5 x i8] c"__z \00", align 1 
@__const_curly.__len.addr = private unnamed_addr constant [12 x i8] c"__len.addr \00", align 1 
@__const_curly.__s = private unnamed_addr constant [5 x i8] c"__s \00", align 1 
@__const_curly.__ob.addr = private unnamed_addr constant [11 x i8] c"__ob.addr \00", align 1 
@__const_curly.__op.addr = private unnamed_addr constant [11 x i8] c"__op.addr \00", align 1 
@__const_curly.__oe.addr = private unnamed_addr constant [11 x i8] c"__oe.addr \00", align 1 
@__const_curly.__iob.addr = private unnamed_addr constant [12 x i8] c"__iob.addr \00", align 1 
@__const_curly.__fl.addr = private unnamed_addr constant [11 x i8] c"__fl.addr \00", align 1 
@__const_curly.__sz = private unnamed_addr constant [6 x i8] c"__sz \00", align 1 
@__const_curly.__ns = private unnamed_addr constant [6 x i8] c"__ns \00", align 1 
@__const_curly.__np = private unnamed_addr constant [6 x i8] c"__np \00", align 1 
@__const_curly.ref.tmp17 = private unnamed_addr constant [11 x i8] c"ref.tmp17 \00", align 1 
@__const_curly.__sp = private unnamed_addr constant [6 x i8] c"__sp \00", align 1 
@__const_curly.ref.tmp33 = private unnamed_addr constant [11 x i8] c"ref.tmp33 \00", align 1 
@__const_curly.cleanup.dest.slot = private unnamed_addr constant [19 x i8] c"cleanup.dest.slot \00", align 1 
@__const_curly.ref.tmp55 = private unnamed_addr constant [11 x i8] c"ref.tmp55 \00", align 1 
@__const_curly.__state.addr = private unnamed_addr constant [14 x i8] c"__state.addr \00", align 1 
@__const_curly.__n.addr = private unnamed_addr constant [10 x i8] c"__n.addr \00", align 1 
@__const_curly.__c.addr = private unnamed_addr constant [10 x i8] c"__c.addr \00", align 1 
@__const_curly.__wide.addr = private unnamed_addr constant [13 x i8] c"__wide.addr \00", align 1 
@__const_curly.__r = private unnamed_addr constant [5 x i8] c"__r \00", align 1 
@__const_curly..addr = private unnamed_addr constant [7 x i8] c".addr \00", align 1 
@__const_curly.__r.addr = private unnamed_addr constant [10 x i8] c"__r.addr \00", align 1 
@__const_curly.__c1.addr = private unnamed_addr constant [11 x i8] c"__c1.addr \00", align 1 
@__const_curly.__c2.addr = private unnamed_addr constant [11 x i8] c"__c2.addr \00", align 1 
@__const_curly.__l.addr = private unnamed_addr constant [10 x i8] c"__l.addr \00", align 1 
; 새로운 전역 str 작성 종료
...
declare void @llvm.memcpy.p0i8.p0i8.i64_curly(i8* noalias nocapture writeonly, i8* noalias nocapture readonly, i64, i1 immarg) #100009 


; for string to char arr func 
declare i64 @_ZNKSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE4copyEPcmm_curly(%"class.curly.std::__1::basic_string"*, i8*, i64, i64) #555555 
...
%temp_var_1_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @__const_curly.cnt2, i64 0, i64 0)) 
...
%temp_var_2_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @__const_curly.cnt2, i64 0, i64 0)) 
...
%temp_var_3_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @__const_curly.cnt2, i64 0, i64 0)) 
...
%temp_var_4_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @__const_curly.cnt2, i64 0, i64 0)) 
...
%temp_var_5_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__const_curly.thread_Cnt, i64 0, i64 0)) 
...
%temp_var_6_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__const_curly.thread_Cnt, i64 0, i64 0)) 
...
%temp_var_7_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__const_curly.retval, i64 0, i64 0)) 
...
%temp_var_8_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__const_curly.argc.addr, i64 0, i64 0)) 
...
%temp_var_9_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__const_curly.argc.addr, i64 0, i64 0)) 
...
%temp_var_10_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.my_sock, i64 0, i64 0)) 
...
%temp_var_11_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.my_sock, i64 0, i64 0)) 
...
%temp_var_12_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__const_curly.cnt, i64 0, i64 0)) 
...
%temp_var_13_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.my_sock, i64 0, i64 0)) 
...
%temp_var_14_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.my_sock, i64 0, i64 0)) 
...
%temp_var_15_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.str_len, i64 0, i64 0)) 
...
%temp_var_16_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__const_curly.randomNum, i64 0, i64 0)) 
...
%temp_var_17_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__const_curly.userInput, i64 0, i64 0)) 
...
%temp_var_18_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.str_len, i64 0, i64 0)) 
...
%temp_var_19_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.tempnum, i64 0, i64 0)) 
...
%temp_var_20_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.tempnum, i64 0, i64 0)) 
...
%temp_var_21_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__const_curly.randomNum, i64 0, i64 0)) 
...
%temp_var_22_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.tempnum, i64 0, i64 0)) 
...
%temp_var_23_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__const_curly.divNum, i64 0, i64 0)) 
...
%temp_var_24_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__const_curly.userInput, i64 0, i64 0)) 
...
%temp_var_25_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__const_curly.randomNum, i64 0, i64 0)) 
...
%temp_var_26_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__const_curly.divNum, i64 0, i64 0)) 
...
%temp_var_27_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__const_curly.result, i64 0, i64 0)) 
...
%temp_var_28_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__const_curly.result, i64 0, i64 0)) 
...
%temp_var_29_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__const_curly.result, i64 0, i64 0)) 
...
%temp_var_30_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__const_curly.stringForTest, i64 0, i64 0)) 
...
%temp_var_31_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @__const_curly.my_sock, i64 0, i64 0)) 
...
%temp_var_32_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__const_curly.retval, i64 0, i64 0)) 
...
%temp_var_33_2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %loadfile, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__const_curly.retval, i64 0, i64 0)) 
